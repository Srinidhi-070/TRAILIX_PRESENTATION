...
export default function PerformanceMetrics() {
  ...
  return (
    <section id="metrics" className="relative py-24 bg-white dark:bg-navy-950/40 border-t border-slate-200 dark:border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-sm md:text-base leading-relaxed font-sans max-w-2xl mx-auto">
              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg bg-slate-50 dark:bg-slate-950 flex items-center justify-center text-slate-600 dark:text-slate-400 group-hover:text-cyan-400 group-hover:border-slate-705 border border-slate-200 dark:border-white/5 shadow-inner transition duration-300">
                      {getIcon(metric.id)}
                    </div>
                    <div>
                ...
                <div className="my-3 space-y-0.5">
                  <div className="text-4xl md:text-5xl font-extrabold text-black dark:text-white tracking-tight flex items-baseline gap-1 select-none">
                    {metric.value}
                    {metric.unit && (
                      <span className="text-lg font-mono font-medium text-slate-600 dark:text-slate-400">{metric.unit}</span>
                    )}
                  </div>
                </div>

                {/* Footnote details */}
                <div className="text-[10px] text-slate-600 dark:text-slate-400 font-sans leading-relaxed border-t border-slate-950 pt-3 mt-1.5 min-h-[40px]">
                  {metric.details}
                </div>
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-white/5 text-left flex gap-3 items-center">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between w-full gap-2">
            ...
            <span className="text-[9px] font-mono text-slate-500 uppercase tracking-widest block bg-slate-50 dark:bg-slate-950 px-2 py-1 rounded border border-slate-200 dark:border-white/5 whitespace-nowrap">
