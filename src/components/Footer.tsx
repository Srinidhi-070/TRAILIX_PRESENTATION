      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10 text-left">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-12 border-b border-slate-200 dark:border-white/5">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col text-left">
                <span className="text-sm font-bold text-black dark:text-white tracking-widest leading-none">TRAILIX</span>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="space-y-1.5 font-sans text-xs text-slate-700 dark:text-slate-300">
