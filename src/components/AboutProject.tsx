...
export default function AboutProject() {
  return (
    <section id="about" className="relative py-24 bg-navy-950/70 border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="p-8 rounded-3xl bg-gradient-to-br from-blue-950/30 to-slate-900/30 border border-white/10 relative overflow-hidden backdrop-blur-md">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-black/40 border border-white/5 flex gap-4 text-left">
                  <div className="p-2.5 h-10 w-10 text-cyan-400 bg-cyan-900/30 rounded-lg flex items-center justify-center">
                    <Compass size={20} />
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-white leading-none mb-1">Spatial Projection Layer</h4>
                    <p className="text-xs text-slate-400 leading-relaxed">Renders responsive pathway markers onto the actual physical space.</p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-black/40 border border-white/5 flex gap-4 text-left">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white leading-none mb-1">Zero Blindspots</h4>
                    <p className="text-xs text-slate-400 leading-relaxed">High-precision multi-floor route handovers across hallways and elevators.</p>
                  </div>
                </div>
              </div>
